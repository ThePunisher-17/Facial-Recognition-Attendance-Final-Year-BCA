...
class Attender(object):
    def __init__(self):  # constructor
        ...
        # cred = credentials.Certificate("Database key\\serviceAccountKey.json")
        ...
        imgBackground = cv2.imread('AdminPanel/Core/Resources/background.png')

        # Importing the mode images into a list
        folderModePath = 'AdminPanel/Core/Resources/Modes'
        ...
        file = open('AdminPanel/Core/EncodedFile.p', 'rb')
