...
class Ui_AdminPanel(object):
    def setupUi(self, AdminPanel):
        ...
        icon = QIcon()
        icon.addFile(u"icons/drawer.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"icons/attender.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.launchAnAttenderLabeled.setIcon(icon4)
        ...
        icon8 = QIcon()
        icon8.addFile(u"icons/favicon_io/favicon.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.launchAnAttender.setIcon(icon4)
        ...
        self.horizontalSpacer_19 = QSpacerItem(263, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_21.addItem(self.horizontalSpacer_19, 1, 2, 1, 1)

        self.empFrame = QFrame(self.page)
        ...
        self.totalEmpLabel.setFont(font)
        ...
        self.gridLayout_21.addWidget(self.empFrame, 1, 0, 1, 1)

        self.adminFrame = QFrame(self.page)
        ...
        self.totalAdminLabel.setFont(font)
        ...
        self.gridLayout_21.addWidget(self.adminFrame, 1, 1, 1, 1)

        self.verticalSpacer_10 = QSpacerItem(20, 417, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_21.addItem(self.verticalSpacer_10, 2, 1, 1, 1)

        self.verticalSpacer_7 = QSpacerItem(20, 417, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.attendanceTableDetailed = QTableWidget(self.page_2)
        ...
        self.gridLayout_7.addWidget(self.downloadCurrentAttendance, 2, 0, 1, 1)
        ...
        self.submitEmpDetails.setFont(font)
        ...
        self.imageSelectionButton.setFont(font)
        icon9 = QIcon()
        ...
        self.Exit.toggled.connect(AdminPanel.close)
        self.Exit_2.toggled.connect(AdminPanel.close)
    ...
    def retranslateUi(self, AdminPanel):
        ...
        self.Exit_2.setText(QCoreApplication.translate("AdminPanel", u"Exit", None))
        ...
        self.label.setText(QCoreApplication.translate("AdminPanel", u"<html><head/><body><p><span style=\" font-size:20pt; font-weight:700; text-decoration: underline;\">Employee List</span></p></body></html>", None))
